...
//        // ADDED: Public property for training trials
//        public List<TrialData> TrainingTrials { get; private set; } = new List<TrialData>();
...
//        /// <summary>
//        /// ADDED: Creates a set of hard-coded training trials.
//        /// </summary>
//        private void CreateTrainingTests()
//        {
//            TrainingTrials.Clear();
//            TrainingTrials.Add(new TrialData(10f, 5f, 5f, 10f));
//            TrainingTrials.Add(new TrialData(8f, 8f, 4f, 12f));
//            TrainingTrials.Add(new TrialData(15f, 2f, 10f, 10f));
//            Debug.Log($"SignallingTrialLoader: Created {TrainingTrials.Count} predefined training trials.");
//        }
//    }
//}